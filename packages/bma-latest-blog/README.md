...
`Balefire\Components\LatestBlog\PostCard::render( $post_id, $show_category )`
...
echo \Balefire\Components\LatestBlog\PostCard::render( $post_id, true );
```
...
`Balefire\Components\LatestBlog\LatestBlog` (PSR-4) and
`Balefire\Components\LatestBlog\PostCard` (PSR-4). Exposes:
