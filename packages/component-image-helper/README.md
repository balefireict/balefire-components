# balefireict/component-image-helper
...
Global functions (thin wrappers around `Balefire\Component\ImageHelper\ImageHelper`):
...
`Balefire\Component\ImageHelper\ImageHelper` (PSR-4). The global functions are
wrappers.
...
```bash
composer update balefireict/component-image-helper
```
