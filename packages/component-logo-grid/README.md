# balefireict/component-logo-grid
...
`Balefire\Component\LogoGrid\LogoGrid` (PSR-4). Exposes:
...
`src/style.css` — uses `data-cols` attribute selector + CSS custom
...
```css
@import "../../vendor/balefireict/component-logo-grid/src/style.css";
```
