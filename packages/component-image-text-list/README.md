# balefireict/component-image-text-list
...
`Balefire\Component\ImageTextList\ImageTextList` (PSR-4). Exposes:
...
`src/style.css` ships the full BEM layout. Mobile (<640px)
...
```css
@import "../../vendor/balefireict/component-image-text-list/src/style.css";
```
